<div class="flex flex-wrap justify-between gap-2 px-4">
    ...
    <div class="flex  sm:items-start items-center  gap-4 mt-12 sm:w-[30%] w-full">
        ...
        <div>
        <h3 class="font-semibold text-sm uppercase text-nowrap">Theodorus Fied Herlando <br> (Kalimantan)</h3>
        <div class="flex flex-col gap-2 mt-3">
            <div class="flex gap-2">
                 <a  class="h-4 w-4 rounded-full border border-landy"></a>
                <a x-data x-tooltip.raw="Landy - Collection 2" class="h-4 w-4 rounded-full bg-landy cursor-pointer"></a>
    ...
    <div class="flex  sm:items-start items-center  gap-4 mt-12 sm:w-[30%] w-full">
        ...
        <div>
        <h3 class="font-semibold text-sm uppercase">Paul Colin P. <br> (Papua)</h3>
        <div class="flex flex-col gap-2 mt-3">
            <div class="flex gap-2">
    ...
    <!-- Card 1 -->
    <div class="flex  sm:items-start items-center  gap-4 mt-12 sm:w-[30%] w-full">
        <img src="https://images.unsplash.com/photo-1632789124528-07b43ba96460?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.0.3" alt="Yoram Dwaa" class="w-32 h-32 object-cover rounded-full" />
        <div>
